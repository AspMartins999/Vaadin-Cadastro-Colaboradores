...
public class ContactForm extends FormLayout { 
  ...
  public ContactForm(List<Departamento> companies, List<Status> statuses) {
    addClassName("contact-form"); 

    binder.bindInstanceFields(this);
    
    departamento.setItems(companies);
    departamento.setItemLabelGenerator(Departamento::getName);
